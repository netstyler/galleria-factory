 ...
 * @package       GalleriaFactory.View.Factory.Galleria.Objects
 */
class GalleriaTheme extends CtkNode {
	 ...
	 */
	protected $_template = 'galleria_theme';
	...
	protected $_params = array(
		'theme' => 'classic',
		'themeFolder' => '/galleria_factory/js/galleria/src/themes/'
	);
	 ...
	 */
	protected $_nodeType = 'galleria-theme';
